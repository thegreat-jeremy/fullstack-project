...
export default {
  ...
  methods: {
    async getSupplier() {
      this.supplier = await this.$get(`/api/supplier/${this.supplier_id}`)
    },
    async doSave() {
      ...
      this.$swal({
        ...
        if (result.isConfirmed) {
          ...
          delete this.supplier.supplier_id
          delete this.supplier.created_datetime

          const r = await this.$put(`/api/supplier/${this.supplier_id}`, {
            param: this.supplier
          })
